...
#====Widgets=======|
        ...
        lbl_courseName=Label(self.root,text="Subject Name", font=("goudy old style",15, 'bold'),bg='white').place(x=10,y=60)
        lbl_Semister=Label(self.root,text="Semister", font=("goudy old style", 15, 'bold'), bg='white').place(x=10,y=100)
...
#====Entry Fields======
        ...
        self.txt_Semister=Entry(self.root, textvariable=self.var_Semister, font=("goudy old style",15,'bold'),bg='lightyellow').place(x=150,y=100,width=200)
        self.txt_year=Entry(self.root, textvariable=self.var_year, font=("goudy old style",15,'bold'),bg='lightyellow').place(x=150,y=140,width=200)
...
#===Search Pannel=====
        ...
        lbl_search_courseName=Label(self.root,text="Subject Name", font=("goudy old style",15, 'bold'),bg='white').place(x=720,y=60)
...
#====content=====
        ...
        self.CourseTable=ttk.Treeview(self.C_Frame,columns=("cid","name","semister","year","description"))
        ...
        self.CourseTable.heading("cid",text="Subject ID")
        self.CourseTable.heading("name",text="Name")
        self.CourseTable.heading("semister",text="Semister")
        ...
        self.CourseTable.column("semister",width=100)
    ...
    def add(self):
        ...
        try:
            if self.var_course.get()=="":
               ...
               row=cur.fetchone()
               if row!=None:
                   messagebox.showerror("Error","Course Name already presenr",parent=self.root)
               else:
                   cur.execute("insert into course (name,Semister,year,description) values(?,?,?,?)",(
                       self.var_course.get(),
        ...
        try:
            if self.var_course.get()=="":
                ...
                if row==None:
                    ...
                    cur.execute("Update course set Semister=?,year=?,description=? where name=?",(
                        self.var_Semister.get(),
                        self.var_year.get(),
                        self.txt_description.get("1.0",END),
                        self.var_course.get()
