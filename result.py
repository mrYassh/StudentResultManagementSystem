...
class resultClass:
    def __init__(self,root):
        ...
        btn_clear=Button(self.root,text="clean",font=("times new roman", 15), bg="lightgreen", activebackground="lightgreen",cursor="hand2",command=self.clear).place(x=430,y=420,width=120,height=35)
    ...
    def search(self):
        ...
        try:
            ...
            if row!=None:
                ...
                messagebox.showerror("Error","No recored found ",parent=self.root)
        except Exception as ex:
            messagebox.showerror("Error",f"Error due to {str(ex)}")
